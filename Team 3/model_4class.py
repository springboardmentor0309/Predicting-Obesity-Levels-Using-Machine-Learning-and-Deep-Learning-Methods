...
model = xgb.XGBClassifier(objective='multi:softmax', num_class=4, max_depth=6, learning_rate=0.1, n_estimators=100, n_jobs=-1)
...
joblib.dump(best_model, 'model_4_category.pkl')
joblib.dump(scaler, 'scaler_4_category.pkl')
